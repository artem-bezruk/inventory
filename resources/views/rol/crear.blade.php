...
@section('modal-content')
	<form id="formCrear" action="{{ route('rol.store', ['locale' => app()->getLocale()]) }}" autocomplete="off">
		<div class="form-row">
		...
		<div class="form-row">
			<div class="form-group col-md-12">
				...
				<input type="text" name="rol" id="rol" class="form-control" placeholder="{{ __('Rol') }}" onkeypress="return keypressvalidarOnlyLetras(event)">
		...
		<div class="form-row">
			<div class="form-group col-md-12">
				...
				<input type="text" name="prioridad" id="prioridad" class="form-control" placeholder="{{ __('Priority') }}" onkeypress="return keypressNumbersInteger(event)">
		...
		<div class="form-row">
			<div class="form-group col-md-12">
				...
				<textarea class="form-control" name="descripcion" id="descripcion" cols="10" rows="5" placeholder="{{ __('Description') }}" onkeypress="return keyPressValidarLetrasyOtrosCaracteres(event)" style="resize: none;"></textarea>

...
@section('modal-id', 'editarcategoria')
@section('modal-title')
	{{ __('Edit') }} {{ __('Category') }}
@endsection
@section('modal-content')
	<form  id="formEditar" action="{{ route('categoria.update', ['locale' => app()->getLocale(), 'categoria' => $data->id]) }}" autocomplete="off">
		@method('PUT')
		<div class="form-row">
		...
		<div class="form-row">
			<div class="form-group col-md-12">
				...
				<input type="text" class="form-control" name="categoria" id="categoria" value="{{ $data->categoria }}" placeholder="{{ __('Category') }}" onkeypress="return keypressvalidarOnlyLetras(event)">
		...
		<div class="form-row">
			<div class="from-group col-md-12">
				<div class="custom-control custom-switch">
					<input type="checkbox" class="custom-control-input" name="capacidad" id="capacidad" value="@if($data->capacidad) 1 @else 0 @endif" @if ($data->capacidad) checked @endif>

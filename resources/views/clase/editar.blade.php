...
@section('modal-id', 'editarclase')
@section('modal-title')
	{{ __('Edit') }} {{ __('Class') }}
@endsection
@section('modal-content')
	<form  id="formEditar" action="{{ route('clase.update', ['locale' => app()->getLocale(), 'clase' => $data->id]) }}" autocomplete="off">
		@method('PUT')
		<div class="form-row">
		...
		<div class="form-row">
			<div class="form-group col-md-12">
				...
				<input type="text" class="form-control" name="clase" id="clase" placeholder="{{ __('Class') }}" value="{{ $data->clase }}" onkeypress="return keypressvalidarOnlyLetras(event)">
